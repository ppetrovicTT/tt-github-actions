...
class TestParseNarrativeResponse:
    def test_parse_valid_json(self):
        narrative = parse_narrative_response(
            VALID_JSON_RESPONSE, model="claude-3",
            prompt_tokens=100, completion_tokens=50, response_time_ms=1200.0,
        )
    ...
    def test_parse_json_in_code_block(self):
        narrative = parse_narrative_response(
            JSON_IN_CODE_BLOCK, model="gpt-4",
            prompt_tokens=200, completion_tokens=60, response_time_ms=900.0,
        )
    ...
    def test_parse_invalid_json_returns_fallback(self):
        narrative = parse_narrative_response(
            INVALID_JSON_RESPONSE, model="gpt-4",
            prompt_tokens=50, completion_tokens=10, response_time_ms=500.0,
        )
    ...
    def test_parse_partial_json_missing_keys(self):
        ...
        narrative = parse_narrative_response(
            PARTIAL_JSON_RESPONSE, model="x",
            prompt_tokens=0, completion_tokens=0, response_time_ms=0.0,
        )
