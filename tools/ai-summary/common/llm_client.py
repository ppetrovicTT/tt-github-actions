...
@dataclass
class LLMMetrics:
    """Aggregated metrics for batch LLM usage."""
    ...
    def avg_response_time_ms(self) -> float:
        return self.total_response_time_ms / self.total_calls if self.total_calls else 0.0

    def summary(self) -> str:
        """Return a formatted summary of metrics."""
        return f"""LLM Usage Metrics:
  ...
  Total response time:   {self.total_response_time_ms/1000:.1f}s
  Avg response time:     {self.avg_response_time_ms:.0f}ms per call"""
